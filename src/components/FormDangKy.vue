      ...
      @submit="submitDangKy"
        ...
        <div class="col-12 mt-2 mb-2">
            <div class="form-check form-group">
                <Field class="form-check-input" name="agree" type="checkbox" v-model="userDangKy.agree" />
                <label class="form-check-label dieukhoansd" for="agree">
                <b>Tôi đồng ý</b><a href="#"> với điều khoản sử dụng của ARCH</a>
                </label>
                       
            </div>
            <ErrorMessage name="agree" class="error-feedback col-10" />    
        </div>
    ...
    export default {
        ...
        data() {
            const userFormSchema = yup.object().shape({  // tạp 1 schema để kiểm tra dữ liệu
                ...
                agree: yup.boolean().oneOf([true], 'Bạn chưa đồng ý với điều khoản của chúng tôi')
