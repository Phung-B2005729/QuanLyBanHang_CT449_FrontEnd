<template>
  ...
  <main>
        <!-- phan cach -->
        <div class="container phancach mt-5">
            <div clas="pchr" >
                <hr style="width: 5rem;flex-grow: 1; height: 3px; margin-right: 1rem;">
            </div>
            <h2 v-if="this.sanphams" class="text-center mb-5">Chi tiết sản phẩm <br/> {{this.sanphams.tenhh}}</h2>
            <div clas="pchr">
        ...
        <div class="log container">
            <div class="row px-xl-4 pb-2">
                <div class="col-xl-5 col-md-10 mb-3">
                    <div class="img_e">
                        <img :src="this.sanphams.linkanh" alt="Khong load được ảnh"
